...
CREATE TABLE CUIDADOR_PACIENTE (
    ...
    FEC_FIN DATE NULL,
   CONSTRAINT [PK_CUIDADOR_PACIENTE] PRIMARY KEY (ID_USUARIO_CUIDADOR, ID_USUARIO_PACIENTE),
     CONSTRAINT FK_CUIDADOR_PACIENTE_USUARIO_CUIDADOR FOREIGN KEY (ID_USUARIO_CUIDADOR) REFERENCES USUARIO(ID_USUARIO),
     CONSTRAINT FK_CUIDADOR_PACIENTE_USUARIO_PACIENTE FOREIGN KEY (ID_USUARIO_PACIENTE) REFERENCES USUARIO(ID_USUARIO)
);
GO
